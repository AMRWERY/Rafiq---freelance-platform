...
const photoSrc = ref("https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=256&q=80");
...
const sandboxAvailability = ref<"available" | "busy" | "unavailable">("available");
